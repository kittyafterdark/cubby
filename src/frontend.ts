...
function ownerLabel(surface: Pick<SpindleHostSurfaceInfo, 'owner'>): string {
...
export async function setup(ctx: SpindleFrontendContext) {
  ...
  function makeSurfaceIcon(surface: SpindleHostSurfaceInfo | undefined, label: string): HTMLElement {
